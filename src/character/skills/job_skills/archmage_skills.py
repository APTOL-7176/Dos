...
def create_archmage_skills():
    ...
    flame_lightning.effects = [
        ...
        DamageEffect(DamageType.BRV, 1.0,
                    gimmick_bonus={"field": "lightning_element", "multiplier": 0.2}),
    ...
    ice_lightning.effects = [
        DamageEffect(DamageType.BRV, 2.2,
                    gimmick_bonus={"field": "ice_element", "multiplier": 0.25}),
    ...
    meteor.effects = [
        ...
        DamageEffect(DamageType.HP, 2.0,
                    gimmick_bonus={"field": "lightning_element", "multiplier": 0.3}),
        GimmickEffect(GimmickOperation.CONSUME, "fire_element", 1),
        GimmickEffect(GimmickOperation.CONSUME, "ice_element", 1),
        GimmickEffect(GimmickOperation.CONSUME, "lightning_element", 1)
    ]
    ...
    arcane_missile.effects = [
        DamageEffect(DamageType.BRV_HP, 2.2,
                    gimmick_bonus={"field": "fire_element", "multiplier": 0.25}),
