...
def create_mage_skills():
    ...
    magic_missile.effects = [
        DamageEffect(DamageType.BRV_HP, 1.3,
                    gimmick_bonus={"field": "fire_element", "multiplier": 0.15}),
        GimmickEffect(GimmickOperation.CONSUME, "fire_element", 1)
    ]
    magic_missile.costs = [MPCost(25)]
    ...
    elemental_fusion.effects = [
        DamageEffect(DamageType.BRV_HP, 1.6,
                    gimmick_bonus={"field": "fire_element", "multiplier": 0.2}),
        DamageEffect(DamageType.BRV, 1.0,
                    gimmick_bonus={"field": "ice_element", "multiplier": 0.2}),
        GimmickEffect(GimmickOperation.CONSUME, "fire_element", 1),
        GimmickEffect(GimmickOperation.CONSUME, "ice_element", 1)
    ]
    elemental_fusion.costs = [MPCost(35)]
    ...
    arcane_explosion.effects = [
        DamageEffect(DamageType.BRV, 1.8,
                    gimmick_bonus={"field": "lightning_element", "multiplier": 0.25}),
        GimmickEffect(GimmickOperation.CONSUME, "lightning_element", 1)
    ]
    arcane_explosion.costs = [MPCost(40)]
    ...
    elemental_storm.costs = [MPCost(55)]
    ...
    ultimate.effects = [
        DamageEffect(DamageType.BRV, 2.2,
                    gimmick_bonus={"field": "fire_element", "multiplier": 0.3}),
        DamageEffect(DamageType.BRV, 2.2,
                    gimmick_bonus={"field": "ice_element", "multiplier": 0.3}),
        DamageEffect(DamageType.HP, 2.5,
                    gimmick_bonus={"field": "lightning_element", "multiplier": 0.35}),
