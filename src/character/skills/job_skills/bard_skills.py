...
def create_bard_skills():
    ...
    scale_up.effects = [
        GimmickEffect(GimmickOperation.ADD, "melody_notes", 3, max_value=7)
    ]
    ...
    crescendo.effects = [
        DamageEffect(DamageType.BRV, 1.5, gimmick_bonus={"field": "melody_notes", "multiplier": 0.3}),
        GimmickEffect(GimmickOperation.ADD, "melody_notes", 1, max_value=7)
    ]
    ...
    perfect_harmony.effects = [
        ...
        GimmickEffect(GimmickOperation.SET, "melody_notes", 0),
    ...
    discord.effects = [
        ...
        GimmickEffect(GimmickOperation.CONSUME, "melody_notes", 2)
    ]
    ...
    ultimate.effects = [
        DamageEffect(DamageType.BRV, 2.0, gimmick_bonus={"field": "melody_notes", "multiplier": 0.5}),
