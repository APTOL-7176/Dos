...
def create_sword_saint_skills():
    ...
    nitoryu.costs = [MPCost(30), StackCost("sword_aura", 2)]
    nitoryu.cooldown = 3
    ...
    kenki_bakuhatsu.costs = [MPCost(40), StackCost("sword_aura", 1)]
    ...
    bisect.costs = [MPCost(50), StackCost("sword_aura", 3)]
    bisect.cooldown = 6
    ...
    ultimate.costs = [MPCost(80), StackCost("sword_aura", 1)]
